    ...
    <div className="landing-root">
      ...
      <nav className="landing-nav">
        <div className="landing-nav-container">
          ...
          >
            ...
            <span className="landing-logo-text">Right to Information</span>
          </div>
        ...
        <div className="features-container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>
                Monitor your RTI requests with live status updates from
                departments.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Automatically generate first or second appeals if responses are
                delayed.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                View performance analytics and response statistics for different
            ...
            <div className="feature-card">
              ...
              <p>
                Citizens can rate departments and share feedback about their RTI
                experience.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Generate structured reports of RTI requests, responses, and
                department activity.
              </p>
            </div>
          </div>
      ...
      <footer className="landing-footer">
        ...
        <div className="footer-bottom">
          <p>© 2026 RTI Assistant. Made for ADCET Hackathon.</p>
        </div>
      </footer>
    </div>
  );
